const grammar = {
  'feature-1': '::game.Primary.title|possessive:: mixture of ::game.Primary.feature::, in a lot of ways, helped pave the way for games like ::game.Secondary.title::.',
  'feature-2': '::game.Primary.title:: let players choose the character they wanted to be and how they wanted to play, all the while maintaining the sensibilities of the ::game.Primary.genre::.',
  'feature-3': '::game.Primary.title:: masterfully balances the ::adjective.open:: levels of other ::game.Primary.genre:: games with the raw, real stories.',
